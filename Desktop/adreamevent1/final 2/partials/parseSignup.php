            ...
            try{
              ...
              VALUES (:username, :email, :password, now())";
                ...
                if($statement->rowCount() == 1){
                    ...
                    //prepare email body
                    $mail_body = '<html>
                    <body style="background-color:#ffffff; color:#000; font-family: Arial, Helvetica, sans-serif;
                                        line-height:1.8em;">
                    ...
                    <p><a href="http://http:///activate.php?id='.$encode_id.'"> Confirm Email</a></p>
                    <p><strong>&copy;2017 AdreamEvents</strong></p>
                    </body>
                    </html>';

                    $mail->addAddress($email, $username);
                    $mail->Subject = "Message from AdreamEvents";
                    $mail->Body = $mail_body;
