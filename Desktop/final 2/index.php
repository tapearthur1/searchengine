<?php
$page_title = "AdreamEvents - Homepage";
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="img/love.jpg" alt="New York" width="1200" height="700">
...
<div>
    <form action="result.php" method="get"> 
		...
		<input type="text" name="user_query" size="80" placeholder="write something to srarch"/> 
...
<div class="container">
  ...
  <div class="row text-center">
    <div class="col-sm-4">
      <div class="thumbnail">
        <a href="http://www.adreamevents.com">
    ...
    <div class="col-sm-4">
      <div class="thumbnail">
       <a href="http://www.adreamevents.com/support.html">
    ...
    <div class="col-sm-4">
      <div class="thumbnail">
       <a href="http://www.adreamevents.com/aboutus.html">
